...
@section('breadcrumb', 'Add Pages')

@section('content')
    <div class="max-w-4xl mx-auto">
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 border border-gray-200 dark:border-gray-700">
            <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-6">Create New Static Page</h3>
            ...
            <form action="{{ route('admin.pages.store') }}" method="POST">
                ...
                <div class="flex justify-end">
                    ...
                    <button type="submit"
                        class="px-6 py-2 bg-blue-600 text-white font-bold rounded hover:bg-blue-700 shadow btn-loading-trigger">Create
                        Page</button>
                </div>
            </form>
        </div>
